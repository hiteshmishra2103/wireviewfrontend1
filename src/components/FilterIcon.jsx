...
const FilterIcon = () => {
    return (
        <>
            <svg className={styles.filterIcon} xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" style={{ fill: 'rgba(0, 0, 0, 1)', transform: '', msFilter: '', marginRight: '10px' }}>
